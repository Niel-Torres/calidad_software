...
public class PopUpMenuEventHandle3 implements PopupMenu.OnMenuItemClickListener {
    Context context;
    View button;

    public PopUpMenuEventHandle3(Context context, View button){
    ...
    public boolean onMenuItemClick(MenuItem item) {
        ...
        if (item.getItemId()== R.id.primerItem3) {
       ...
       if (item.getItemId()==R.id.segundoItem3){
           Button b = (Button) this.button;
           CharSequence nombre = item.getTitle();
           b.setText(nombre);
           int ident = button.getId();
        ...
        if (item.getItemId()==R.id.tercerItem3){
            Button b = (Button) this.button;
            CharSequence nombre = item.getTitle();
            b.setText(nombre);
            int ident = button.getId();
